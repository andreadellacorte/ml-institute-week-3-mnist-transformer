...
def verify_expected_loss(expected_loss, model):
...
def verify_input_independent_baseline():
...
def main():
    ...
    verify_expected_loss(expected_loss, model)

    verify_input_independent_baseline()
